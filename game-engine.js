...
(  {id:'rice',name:'お米',cat:'carb',catL:'炭水化物',eff:'食材山札からカードを1枚引く。'},
  ...
  {id:'miso',name:'味噌',cat:'protein',catL:'たんぱく質',eff:'自分は手札の「たんぱく質」のカードを1枚選び、ごみ箱に送ってもよい。そうしたなら、自分は食材山札からカードを1枚引く。'},
...
const ING_BLOCKS = {
  ...
  miso: [{ type: 'discardHand', n: 1, optional: true, filterKey: 'protein' }, { type: 'ifPrev' }, { type: 'drawIng', n: 1 }],
