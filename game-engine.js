...
const ING_DEFS = [
  ...
  {id:'chili',name:'唐辛子',cat:'vitamin',catL:'ビタミン',eff:'このカードをごみ箱に送る。相手のターン終了時まで、相手が料理を提供するたびに自分の満腹度-1。'},
...
const REC_DEFS = [
  ...
  {id:'minestrone',name:'ミネストローネ',sat:7,req:['potato','pork','carrot','cabbage','tomato','onion'],eff:'ごみ箱から食材カードを2枚選び手札に加える。その後、自分の満腹度-2。'},
...
const REC_BLOCKS = {
  ...
  minestrone: [{ type: 'recoverTrash2', n: 2, filterKey: 'ingredient' }, { type: 'redSelfSat', n: 2 }],
